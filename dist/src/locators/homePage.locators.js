...
exports.HOME_PAGE_LOCATORS = void 0;
exports.HOME_PAGE_LOCATORS = {
    ...
    prodtableHeaders: "//table[@id='prod_dashboard']//tr[@class='prod_dashboard_tbl_header']",
    ...
    productionDashboardLoadButton: "//input[@name='submit_query' and @value='Load Production Dashboard']",
    productionDashboardDataGrid: "//table[@id='production_dashboard_grid']",
    productionDashboardTableRow: "//table[@id='prod_dashboard']//tr[@class='prod_dashboard_tbl_header']",
    productionDashboardTableCell: ".production-dashboard-table td",
    translationStatusdropdown: "//select[@id='translation_note_section_select_4360']",
    prodEditor: "//*[@id='prod_dashboard']/tbody/tr[3]/td[12]/img",
    prodSaveButton: "(//input[@type='button' and starts-with(@value, 'Save') and not(ancestor::div[contains(@style, 'display:none')])])[1]",
    ...
    tipRowByTipText: (tip) => `xpath=//tr//a[.//text()[normalize-space()="${tip}"]]`,
    editIconByTip: (tip) => `img[alt="Edit the tip - ${tip}"]`,
    deleteIconByTip: (tip) => `img[alt="Delete the tip - ${tip}"]`,
    tipRow: (tip) => `xpath=//tr//a[.//text()[normalize-space()="${tip}"]]`,
    editIcon: (tip) => `//img[@alt="Edit the tip - ${tip}"]`,
    deleteIcon: (tip) => `//img[@alt="Delete the tip - ${tip}"]`,
